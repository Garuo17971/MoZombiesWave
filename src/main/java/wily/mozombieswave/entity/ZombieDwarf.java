...
public class ZombieDwarf extends AbstractMoZombie {
		...
		{
			public final ResourceLocation TEXTURE = new ResourceLocation(MozombiesWaveMod.MODID, "textures/entity/" + name +".png");
	...
	protected float getStandingEyeHeight(Pose p_34313_, EntityDimensions p_34314_) {
		...
		public static class ZombieDwarfModel<T extends AbstractMoZombie> extends HumanoidModel<T> {
			...
			public static final ModelLayerLocation DWARF = new ModelLayerLocation(new ResourceLocation(MozombiesWaveMod.MODID, name), "main");
			public static final ModelLayerLocation DWARF_INNER = new ModelLayerLocation(new ResourceLocation(MozombiesWaveMod.MODID, name + "_inner"), "main");
			public static final ModelLayerLocation DWARF_OUTER = new ModelLayerLocation(new ResourceLocation(MozombiesWaveMod.MODID, name + "_outer"), "main");
